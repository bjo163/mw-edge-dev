...
- fix(steward): consume governance drift probe (b0b458b)
- feat(migration): apply deterministic numbered migrations (a8fc01f)
- feat(web): localize create form chrome (3bcfd49)
- docs(performance): avoid false pnpm script reference (4af81e8)
- perf: make V1 load and SQLite soak evidence canonical (#483) (af79cd2)
- chore(perf): remove duplicate baseline runner (#118) (ada719b)
- ci(nightly): use canonical performance baseline (#118) (eedba6a)
- ci: enforce performance and SQLite evidence (#118 #119) (fcf70b6)
- docs(perf): align SQLite soak methodology and limits (#119) (7d7bcda)
- docs(perf): align production load evidence with canonical benchmark (#118) (8f34763)
- perf(sqlite): bound sustained working set and integrity checks (#119) (1578a47)
- perf: add repeatable production load baseline (#118) (df46051)
- merge: fast-track P0 domain lifecycle (#482) (9ae8b9c)
- merge: fast-track P0 domain lifecycle (#481) (db4bbbc)
- merge: fast-track P0 domain lifecycle (#480) (a094744)
- merge: fast-track P0 domain lifecycle (#479) (811ad7c)
- merge: fast-track P0 domain lifecycle (#478) (e3e4cec)
- merge: fast-track P0 domain lifecycle (#477) (c01b53c)
- feat(billing): add guarded invoice lifecycle (#12 #13) (bf7c4ae)
- test(support): cover ticket lifecycle isolation (#17) (c8fd9a5)
- feat(support): add guarded ticket lifecycle (#17) (d6aa285)
- test(provisioning): cover reference-only state machine (#16) (8c518de)
- feat(provisioning): add reference lifecycle (#16) (071da04)
- test(entitlement): cover authorized allocation lifecycle (#15) (1f47b0b)
- feat(entitlement): add allocation lifecycle (#15) (1999829)
- test(billing): cover invoice and payment observation guards (#12 #13 #14) (1869f46)
- feat(billing): guard payment observation semantics (#14) (81b1493)
- test(service): cover subscription lifecycle boundaries (#10 #11) (f6a0814)
- feat(service): add guarded subscription lifecycle (#10 #11) (93034d2)
- test(commerce): cover order transition matrix (#8 #9) (ed20b4c)
- feat(commerce): add guarded order lifecycle (#8 #9) (e78ed76)
- chore(contracts): freeze v1 extension surfaces (#474) (b94f24e)
- test(orm): namespace pagination fixture ranks (#475) (29d6d37)
- test(orm): namespace pagination fixture ranks (#68) (3c39ab4)
- test(contracts): pin v1 frozen extension set (#122) (9c7d6e8)
- docs(contracts): record v1 extension freeze (#122) (ccb5a27)
- chore(contracts): freeze v1 extension surfaces (#122) (81f2fed)
- test(orm): isolate seeded pagination fixtures (#473) (d1bb9a5)
- test(orm): isolate pagination fixtures from seeded rows (#68) (9db2f83)
- feat(orm): add bounded query shaping and pagination (#472) (0d8b83d)
